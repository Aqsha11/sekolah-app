...
const SEEDS = [
  ...
  { id: "seed-117", oklch: [0.650, 0.100, 110.0],
    mood: "Klim-style editorial sage — late-summer foundry catalogue, considered olive-blue on paper",
  ...
  { id: "seed-118", oklch: [0.750, 0.090, 110.0],
    ...
    strategy: "Pure white bg lets a desaturated olive-blue primary do the editorial work, with a deeper olive-bronze accent providing typographic emphasis the way a specimen uses one heavy weight against the body roman." },
  ...
  { id: "seed-182", oklch: [0.400, 0.106, 150.0],
    ...
    strategy: "Near-black bg with the faintest cool-green undertone evokes shaded stone; primary holds the seed's moss tone while accent shifts to a lichen-blue for organic counterpoint without breaking the hush." },
...
function hueWord(H) {
  ...
  if (H < 135) return 'blue-green / olive';
