...
@section('content')
    <div class="bg-white p-6 rounded-xl shadow">
        ...
        <h1 class="text-2xl font-bold mb-6">Tambah Alumni</h1>
        ...
        <form action="{{ route('admin.alumni.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="tahun_lulus" value="{{ old('tahun_lulus') }}"
                    class="w-full border rounded-lg p-2 focus:ring focus:ring-primary-300" required placeholder="Contoh: 2020">
            </div>

            <div>
                <label class="block font-semibold mb-1">Pekerjaan</label>
                <input type="text" name="pekerjaan" value="{{ old('pekerjaan') }}"
                    class="w-full border rounded-lg p-2 focus:ring focus:ring-primary-300" placeholder="Contoh: Mahasiswa UI">
            </div>
