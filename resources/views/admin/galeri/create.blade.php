...
<div class="bg-white p-6 rounded-xl shadow">
    ...
    <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="title" placeholder="Masukkan judul galeri" class="w-full border rounded-lg p-2 focus:ring focus:ring-primary-300" required>
        </div>
        <div>
            <label class="block font-semibold mb-1">Deskripsi</label>
            <textarea name="description" placeholder="Tuliskan deskripsi galeri" class="w-full border rounded-lg p-2 focus:ring focus:ring-primary-300" rows="4"></textarea>
        </div>
        <div>
