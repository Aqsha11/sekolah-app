...
@section('content')
    <div class="bg-white p-6 rounded-xl shadow">
        ...
        <h1 class="text-2xl font-bold mb-6">Tambah Agenda</h1>
        ...
        <form action="{{ route('admin.agenda.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" class="w-full border rounded-lg p-2 focus:ring focus:ring-primary-300" placeholder="Tuliskan deskripsi agenda">{{ old('deskripsi') }}</textarea>
            </div>
