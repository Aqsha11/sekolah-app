    ...
    <div class="bg-white p-6 rounded-xl shadow">
        ...
        <form action="{{ route('admin.fasilitas.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan nama fasilitas"
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Tuliskan deskripsi fasilitas" class="w-full border rounded-lg p-2 focus:ring focus:ring-primary-300">{{ old('description') }}</textarea>
            </div>
